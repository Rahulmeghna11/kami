    ...
    if user_id in ADMIN_IDS:
        ...
        if len(command) == 2:
            try:
                ...
                response = "Please specify a valid number and unit of time (hours/days) script by 1@RAHUL_DDOS_B."
        else:
...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flooding_command = ['./bgmi', target_ip, port, duration]
...
if __name__ == '__main__':
    main()
#VIPKAMISAMA DEVELOPERS KI MAA KI CHUT 
